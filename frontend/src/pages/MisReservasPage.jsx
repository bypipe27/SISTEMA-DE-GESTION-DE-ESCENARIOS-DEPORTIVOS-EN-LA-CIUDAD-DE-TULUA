...
function MisReservasPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-rose-100 flex">
      {/* SIDEBAR */}
      ...
      <div className="flex-1 ml-64">
        <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="max-w-7xl mx-auto">
            {/* Header */}
            <div className="mb-8 bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border-2 border-purple-200">
              <h2 className="text-3xl sm:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-pink-600 to-rose-600">Mis Reservas</h2>
            ...
            <div className="bg-gradient-to-br from-white via-purple-50 to-pink-50 p-4 sm:p-6 rounded-2xl shadow-lg border-2 border-purple-200 mb-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="relative col-span-1 md:col-span-1">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 border-2 border-purple-200 rounded-xl bg-white/80 backdrop-blur-sm focus:ring-2 focus:ring-pink-400 focus:border-pink-400 transition-all duration-300 placeholder-purple-300"
                  />
                </div>

                {/* Filtro por estado */}
                <div className="relative col-span-1 md:col-span-1">
                  <FaFilter className="absolute left-3 top-1/2 -translate-y-1/2 text-purple-400" />
                  <select
                    value={filterStatus}
                    onChange={(e) => setFilterStatus(e.target.value)}
                    className="w-full pl-10 pr-4 py-2.5 border-2 border-purple-200 rounded-xl bg-white/80 backdrop-blur-sm focus:ring-2 focus:ring-pink-400 focus:border-pink-400 transition-all duration-300 appearance-none"
                  >
                ...
                <div className="col-span-1 md:col-span-1">
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold py-2.5 px-4 rounded-xl flex items-center justify-center gap-2 hover:from-purple-700 hover:to-pink-700 transition-all duration-300 shadow-md hover:shadow-lg"
                  >
                    <FaSearch />
            ...
            {loading ? (
              <div className="text-center py-12 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg">
                <div className="animate-spin rounded-full h-16 w-16 border-4 border-t-transparent border-purple-500 mx-auto"></div>
              ...
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="text-center py-12 bg-gradient-to-br from-white via-purple-50 to-pink-50 rounded-2xl shadow-lg border-2 border-purple-200"
              >
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold py-3 px-6 rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all duration-300 shadow-md hover:shadow-lg"
                >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {reservas.map((reserva, index) => {
                  ...
                  // Colores de badge según estado - esquema unificado purple-pink-rose
                  const badgeClasses = {
                  ...
                  // Determinar gradiente de fondo según estado - tonos suaves unificados
                  const cardGradients = {
                    ...
                    purple: "from-white via-purple-50/30 to-fuchsia-50/30",
                  ...
                  return (
                    <motion.div
                      ...
                      className={`bg-gradient-to-br ${cardGradients[estado.color] || cardGradients.green} rounded-2xl shadow-lg border-2 border-purple-200/60 overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:border-purple-300 ${opacityClass}`}
                    >
                      <div className="p-6 bg-white/40 backdrop-blur-sm">
                        {/* Header con nombre y badge */}
                        <div className="flex justify-between items-start mb-4">
                          <div>
                            <h3 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-700 to-pink-700">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                          <div className="flex items-center gap-3 bg-white/90 p-3 rounded-xl shadow-sm border border-purple-100">
                            <div className="bg-gradient-to-br from-purple-500 to-fuchsia-600 p-2 rounded-lg shadow-md">
                          ...
                          <div className="flex items-center gap-3 bg-white/90 p-3 rounded-xl shadow-sm border border-purple-100">
                            <div className="bg-gradient-to-br from-pink-500 to-rose-600 p-2 rounded-lg shadow-md">
                          ...
                          <div className="flex items-center gap-3 bg-white/90 p-3 rounded-xl shadow-sm border border-purple-100">
                            <div className="bg-gradient-to-br from-fuchsia-500 to-purple-600 p-2 rounded-lg shadow-md">
                          ...
                          <div className="flex items-center gap-3 bg-white/90 p-3 rounded-xl shadow-sm border border-purple-100">
                            ...
                            <div>
                              ...
                              <p className="font-bold text-lg text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-fuchsia-600">${precioNum.toLocaleString()} COP</p>
                            </div>
                          </div>
                        </div>
            ...
            {reservas.length > 0 && (
              <motion.div
                ...
                className="mt-8 bg-gradient-to-br from-white via-purple-50 to-pink-50 rounded-2xl shadow-lg p-6 border-2 border-purple-200"
              >
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-center">
                  <div className="bg-gradient-to-br from-purple-50 to-fuchsia-50 p-4 rounded-xl border-2 border-purple-300 shadow-sm">
                    <p className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-fuchsia-600">{estadisticas.total}</p>
                    <p className="text-sm font-semibold text-slate-700 mt-1">Total Reservas</p>
                  </div>
                  <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-4 rounded-xl border-2 border-blue-300 shadow-sm">
                  ...
                  <div className="bg-gradient-to-br from-emerald-50 to-teal-50 p-4 rounded-xl border-2 border-emerald-300 shadow-sm">
                  ...
                  <div className="bg-gradient-to-br from-slate-50 to-gray-50 p-4 rounded-xl border-2 border-slate-300 shadow-sm">
                  ...
                  <div className="bg-gradient-to-br from-rose-50 to-red-50 p-4 rounded-xl border-2 border-rose-300 shadow-sm">
