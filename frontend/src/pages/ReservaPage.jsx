          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-start">
              ...
              <div className="lg:col-span-2 space-y-6">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              // Solo actualizar con números válidos
                            ...
                            onPaste={(e) => {
                              ...
                              if (onlyNumbers) {
                                setClienteTelefono(onlyNumbers);
                              }
                            }}
                ...
                />
                {/* Sección de reseñas: ubicada en la columna izquierda, debajo del recuadro de reserva */}
                <div className="bg-white/90 p-4 rounded-2xl shadow-lg border border-slate-100 mt-6">
                  <h4 className="text-lg font-semibold mb-3">Reseñas</h4>
                  <ReviewsList canchaId={cancha.id} />
                  <div className="mt-4">
                    <ReviewForm canchaId={cancha.id} currentUser={usuario} onSuccess={() => { /* opcional: refrescar stats */ }} />
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-1 space-y-6">
                ...
                <div className="bg-gradient-to-br from-white via-emerald-50/30 to-teal-50/30 p-6 rounded-2xl shadow-lg border-2 border-emerald-200">
                  <h3 className="text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-600 mb-2">Resumen de la reserva</h3>
                  <div className="flex items-center gap-3 mb-4">
                    <div className="flex items-center gap-2">
                      <RatingWidget value={Number(stats.avg) || 0} readOnly />
                      <div className="text-sm text-slate-600">
                        <div><strong className="text-slate-800">{(Number(stats.avg) || 0).toFixed(1)}</strong> promedio</div>
                        <div className="text-xs">{stats.count ?? 0} reseñas</div>
                      </div>
                    </div>
                  </div>
